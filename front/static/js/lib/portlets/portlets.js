 ...
 * It converts the style attribute to css2 object
 *
 * @returns {object}
 */
...
//------------------------------------------------------------------------------
        ...
        maximize: function () {
            ...
            if (me.isPinned()) {
                ...
                me.enableTooltips();
                //we get css2 style which was saved before minimization
                var css = me.$el.attr('old-style').getCss();
                //we give panel these css2 properties, coz animation work
                me.$el.css({
...
//            css2['position'] = 'absolute';
        ...
        toFullScreen: function () {
            ...
            //other css2 properties and we append panel into body
        ...
        toSmallSize: function () {
            ...
            me._changeClassOfControl(me.$heading.find('[data-func="expand"]'));
            var css = me.$el.attr('old-style').getCss();
            //we get css2 properties from old-style (saved before expanding)
            //and we animate panel to this css2 properties
            me.$el.animate({
                position: 'absolute',
                left: css.left,
                top: css.top,
    ...
    LobiPanel.PRIVATE_OPTIONS = {
        ...
        //First instance on lobiPanel will get this z-index css2 property.
